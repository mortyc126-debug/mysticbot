  ...
  const tiers = [
    {
      ...
      features: ["Персональный гороскоп на день", "3 гадания в день (расклад на 3 карты)", "Совместимость знаков (детальный анализ)", "Лунный календарь с рекомендациями", "Расширенный сонник"]
    },
    {
      id: "premium", name: "👑 Премиум", price: "499₽/мес",
      color: "var(--gold2)", borderColor: "rgba(245,158,11,0.28)",
      features: ["Всё из VIP", "Натальная карта (1 раз в неделю)", "Хиромантия по фото руки", "Персональный астролог", "Все расклады Таро (Кельтский крест и др.)", "Руна-оберег · Проверка ауры", "5 гаданий в день · Приоритет"]
    },
  ];
