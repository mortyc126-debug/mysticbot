...
export const useAppState = () => {
  ...
  // Уведомления отправляются только через бота (CRON /api/notifications каждый день в 6:00 UTC).
  // Триггер из приложения удалён — бот сам рассылает всем зарегистрированным пользователям.
