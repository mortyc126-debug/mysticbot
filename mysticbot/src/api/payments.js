...
export const SUBSCRIPTION_PRICES = {
  vip: {
    ...
    emoji: "⭐",
    features: ["5–10 гаданий в день", "Три карты и Отношения", "2× очки удачи", "VIP гороскоп"],
  },
  premium: {
    amount: 499,
    currency: "RUB",
    ...
    emoji: "👑",
    features: ["Все расклады без ограничений", "Натальная карта", "Хиромантия и Аура", "Руны", "Кельтский крест"],
  },
};
