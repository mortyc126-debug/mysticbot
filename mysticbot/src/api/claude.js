...
Дай глубокое профессиональное чтение ладони (350–450 слов). По каждой линии — конкретные наблюдения: длина, изгиб, разрывы, вилки, знаки. Никаких общих фраз.

1. Линия жизни — подробно: запас жизненной силы, переломные периоды, здоровье, энергетика. Есть ли разрывы или ответвления — что они говорят.
2. Линия сердца — эмоциональный мир: способность любить, характер отношений, скрытые чувства. Куда уходит линия, насколько она чёткая.
3. Линия ума — стиль мышления, интуиция vs логика, творческие или аналитические способности. Длина и наклон говорят о подходе к решениям.
4. Линия судьбы — карьера, призвание, влияние судьбы. Где начинается, как идёт — это история жизненного пути.
5. Дополнительные знаки — бугры, звёзды, кресты, кольца (если видны). Что они усиливают.
6. Прогноз на ближайший год — конкретно: какие сферы активизируются, что требует внимания, что придёт.

В конце — общий вывод: главный посыл ладони для этого человека. Учти знак зодиака и приоритеты. Без markdown, без заголовков — сплошной живой текст хироманта.`;
    ...
    // compressedBase64 возвращается чтобы Palmistry.jsx загружал именно его в Supabase
    // (оригинал может превышать 5MB лимит backend, сжатое — всегда в пределах нормы)
    return text ? { lines: [], summary: text, prediction: "", compressedBase64, compressedMimeType: "image/jpeg" } : null;
  } catch (e) {
