...
Дай интерпретацию (150–250 слов). Создай нарративную связь между картами. В самом конце — краткий и ясный ответ на вопрос пользователя простым языком (2–3 предложения, без мистики, чтобы было понятно каждому).`;
...
Прочитай сон как послание из глубин. Раскрой, что подсознание пытается сказать. Вплети образы сна в нить жизни этого человека — без сухого анализа, через ощущения и символы. В конце — краткий и ясный ответ простым языком: что этот сон значит и что делать. Говори поэтично и точно — 150–200 слов.`;
...
Читай руны как единую систему, не по отдельности. Покажи, как они переплетаются в один ответ на вопрос. Говори языком древнего знания — образно, но точно. В конце — краткий и ясный ответ простым языком (2–3 предложения). 150–200 слов. Без markdown.`;
